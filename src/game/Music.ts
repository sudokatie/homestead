/**
 * Music system for Homestead using Web Audio API.
 * Generates peaceful, pastoral farming chiptune background music.
 */
...
class MusicSystem {
  ...
  private playNote(freq: number, startTime: number, duration: number, vol: number = 1): void {
    ...
    // Sine wave for gentle, peaceful feel
    osc.type = 'sine';
  ...
  // Gameplay track - peaceful farm, pastoral life
  private getGameplayNotes(): Note[] {
    ...
    // Pastoral farming melody (8 bars)
    const melody = [
      // Bar 1-2: Morning on the farm
      { note: 'C4', dur: quarter },
      { note: 'E4', dur: eighth },
      { note: 'G4', dur: eighth },
      { note: 'E4', dur: half },
  ...
  // Menu track - peaceful morning anticipation
  ...
  // Victory track - bountiful harvest
